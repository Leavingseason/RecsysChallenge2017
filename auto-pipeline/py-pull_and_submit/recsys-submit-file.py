...
if __name__ == "__main__":
	...
	path = r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\camera_ready'
	offline_submit(path+r'\test-FT_FT_laglng_premium0.005_submit_complete.txt')

	
	#download_interactions()
	#download_acceptsubmission();
	
	#online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit.csv')
	r'''
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v1.csv')
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v2.csv')
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v3.csv')
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v4.csv')
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v5.csv')
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v6.csv')
	online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v7.csv')
	'''
	#online_submit(r'\\mlsdata\e$\Users\v-lianji\mlsdata\Recsys17\submit\online\recsys17-pred-highdim-submit_v-1.csv')
